<?php
 ...
 if(isset($_POST['postReview']))
 {
    ...
    $reviewerLastName = $_SESSION['user_last_name'] ;
...
<html lang="en">
  ...
  <body>
   <?php
     if($failure)
     {
        echo '<div class="alert alert-warning alert-dismissible fade show" role="alert">Please fill all fields.</div>';
      }
      if($success)
      {
        echo '<div style="background:rgb(212,237,218); color:rgb(53,112,67);" class="alert alert-warning alert-dismissible fade show" role="alert">Thank you for your review!</div>';
      }
   ?>
   <header style="height:100px;">
      <a href="../Home/home_user.php"><img style="width: 200px;" src="../img/Logo/ZiriLogoBlack.png" alt=""></a>
   </header>
   <section class="modal container">
      <div class="modal__container" id="modal-container">
        <div class="modal__content">
          <div class="modal__close close-modal" title="Close">
            <a href="../UserSession/user-page.php"><i class="fa-solid fa-xmark"></i></a>
          </div>
          <form method="post">
            <div class="names">
              <p><span name="reviewerName"><?php echo $_SESSION['user_name']?></span>&nbsp;<span name="reviewerLastName"><?php echo $_SESSION['user_last_name']?></span></p>
            </div>
            <h1 class="modal__title">Please rate your experience!</h1>
            <div align="center"  style="background: none; color:#7e7eb5; position:relative;top:10px; cursor:pointer;">
           ...
           <button type="submit" name="postReview" class="modal__button-link close-modal">Submit</button>
         </form>
       </div>
     </div>
   </section>  
