...
<html lang="en">
 ...
 <body>
     <!-- the header -->
     <?php
         require('../Header/header_guest.php')
       ?>
       <!-- properties page -->
             ...
             <div class="form-control max-w-xs">
              ...
              <div class="form-control max-w-xs">
                 ...
                 <select class="select" name="rentalListingType" id="searchBoxListingType" onchange="redirectToPage()">
                     <option value="">All</option>  
                     <option class="option" value="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Entire%20place">Entire place</option>
                     <option class="option" value="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Private%20room">Private room</option>
                     <option class="option" value="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Shared%20room">Shared room</option>
                     <option class="option" value="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Hotel%20room">Hotel room</option>
                     <option class="option" value="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Unique%20stays">Unique stays</option>
                     <option class="option" value="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Bed%20and%20breakfast">Bed and breakfast</option>
                 </select>
             </div>
         </div>
         <?php 
         ...
         <?php foreach($properties as $property):?>
                 <div class="property-box">
                     ...
                     <div class="property-box-overlay">
                         <a class="fancy" href="../GuestSession/rentalDetails_guest.php?rentalMoreDetails=<?php echo $property->id ?>">
