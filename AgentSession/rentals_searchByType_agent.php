             ...
             <div class="form-control max-w-xs">
              ...
              <div class="form-control max-w-xs">
                 ...
                 <select class="select" name="rentalListingType" id="searchBoxListingType" onchange="redirectToPage()">
                     <option value="">All</option>  
                     <option class="option" value="../AgentSession/rentals_searchByType_agent.php?rentalListingType=Entire%20place">Entire place</option>
                     <option class="option" value="../AgentSession/rentals_searchByType_agent.php?rentalListingType=Private%20room">Private room</option>
                     <option class="option" value="../AgentSession/rentals_searchByType_agent.php?rentalListingType=Shared%20room">Shared room</option>
                     <option class="option" value="../AgentSession/rentals_searchByType_agent.php?rentalListingType=Hotel%20room">Hotel room</option>
                     <option class="option" value="../AgentSession/rentals_searchByType_agent.php?rentalListingType=Unique%20stays">Unique stays</option>
                     <option class="option" value="../AgentSession/rentals_searchByType_agent.php?rentalListingType=Bed%20and%20breakfast">Bed and breakfast</option>
                 </select>
             </div>
         </div>
         <?php 
