<?php
  ...
  if(isset($_POST['add_rental']))
  {
    ...
    {
      $sql = "SELECT COUNT(*) AS rentalCount FROM vacationrentals WHERE rentalPosterName = '{$_SESSION['agent_name']}' AND rentalPosterLastName = '{$_SESSION['agent_last_name']}'";
  ...
  $query = "SELECT phoneNumber FROM user WHERE user_type='agent' AND name = '{$_SESSION['agent_name']}' AND last_name = '{$_SESSION['agent_last_name']}'";
