...
if (mysqli_num_rows($result) > 0) {
  ...
  if (isset($_POST['DeleteRental']))
  {
    ...
    DeleteRental($id);
    header('location:../AgentSession/MyRentals_agent.php');
    exit();
  }
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="d-flex flex-column ">
                            <button class="btn btn-primary " style="margin-bottom: 7px;" type="button"><a style="color: white;" href="../AgentSession/rentalDetails_agent.php?rentalMoreDetails=<?php echo $myRental->id ?>">View all</a></button>
                            <form method="post" style="display: contents;">
                                <button class="btn btn-primary " style="margin-bottom: 7px;" type="button"><a style="color: white;" href="../AgentSession/editRental_agent.php?editRental=<?= $myRental->id ?>">Edit</a></button>
                            </form>
