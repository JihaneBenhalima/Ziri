 ...
 <body>   
     ...
     <div class="container">
         ...
         <div class="box-container"> 
             <a class="box" href="../UserSession/properties_searchByType_user.php?propertyType=Family%20home" >
                 <img src="../img/propertiesCategories/familyhouse.jpg" alt="">
                 <h3>Family home</h3>
             </a>
             <a class="box" href="../UserSession/properties_searchByType_user.php?propertyType=apartment">
                 <img src="../img/propertiesCategories/apartment.jpg" alt="">
                 <h3>Apartment</h3>
             </a>
             <a class="box" href="../UserSession/properties_searchByType_user.php?propertyType=Duplex">
                 <img src="../img/propertiesCategories/duplex.jpg" alt="">
                 <h3>Duplex</h3>
             </a>
             <a class="box" href="../UserSession/properties_searchByType_user.php?propertyType=Villa">
                 <img src="../img/propertiesCategories/villa1.jpg" alt="">
                 <h3>Villa</h3>
             </a>
             <a class="box" href="../UserSession/properties_searchByType_user.php?propertyType=Farm%20house">
                 <img src="../img/propertiesCategories/Farmhouse.jpg" alt="">
                 <h3>Farm house</h3>
             </a>
             <a class="box" href="../UserSession/properties_searchByType_user.php?propertyType=Retail%20property">
                 <img src="../img/propertiesCategories/retailProperty.jpg" alt="">
                 <h3>Retail property</h3>
             </a>
             <a class="box" href="../UserSession/properties_searchByType_user.php?propertyType=Office%20building">
                 <img src="../img/propertiesCategories/Office.jpg" alt="">
                 <h3>Office building</h3>
             </a>
             <a class="box" href="../UserSession/properties_searchByType_user.php?propertyType=Warehouse">
                 <img src="../img/propertiesCategories/Warehouse.jpg" alt="">
                 <h3>Warehouse</h3>
             </a>
             <a class="box" href="../UserSession/properties_searchByType_user.php?propertyType=Land">
