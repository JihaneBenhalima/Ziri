    ...
    ?>
     <div class="container">
         ...
         <div class="box-container"> 
             <a class="box" href="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Entire%20place" >
                 <img src="../img/propertiesCategories/entirePlace.jpg" alt="Entire place">
                 <h3>Entire place</h3>
             </a>
             <a class="box" href="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Private%20room">
                 <img src="../img/propertiesCategories/privateRoom.jpg" alt="Private room">
                 <h3>Private room</h3>
             </a>
             <a class="box" href="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Shared%20room">
                 <img src="../img/propertiesCategories/sharedRoom.jpg" alt="Shared room">
                 <h3>Shared room</h3>
             </a>
             <a class="box" href="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Hotel%20room">
                 <img src="../img/propertiesCategories/hotelRoom.jpg" alt="Hotel room">
                 <h3>Hotel room</h3>
             </a>
             <a class="box" href="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Unique%20stays">
                 <img src="../img/propertiesCategories/uniqueStays.jpg" alt="Unique stays">
                 <h3>Unique stays</h3>
             </a>
             <a class="box" href="../GuestSession/rentals_searchByType_guest.php?rentalListingType=Bed%20and%20breakfast">
